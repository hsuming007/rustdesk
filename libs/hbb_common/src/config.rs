...
lazy_static::lazy_static! {
    ...
    pub static ref OVERWRITE_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Aa37592723".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["125.227.103.193"];
pub const PUBLIC_RS_PUB_KEY: &str = "umQHQJmI2yIvAea4vmtkdu68ywMV2ov5XOeMpMCPvxY=";
